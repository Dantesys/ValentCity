            ...
            if(tri.getItemStack().isSimilar(Reliquias.tridente_modelo1)){
                ...
                if(block != null){
                    ...
                    if(entity instanceof Zombie zombie){
                        ...
                        meta.displayName(Component.text("§b Ocean Lord"));
                        ...
                        Objects.requireNonNull(zombie.getAttribute(Attribute.GENERIC_SCALE)).setBaseValue(1.3);
                        zombie.setGlowing(true);
                        zombie.setVisualFire(true);
                        ((LivingEntity) zombie).getEquipment().setItemInMainHand(item);
                        ...
                        ((LivingEntity) zombie).getEquipment().setHelmet(new ItemStack(Material.TURTLE_HELMET));
                        ((LivingEntity) zombie).getEquipment().setItemInOffHand(new ItemStack(Material.SHIELD));
